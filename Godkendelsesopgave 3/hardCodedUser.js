...
let user2 = new User('Camilla', 'Jensen', 'Cam3@live.dk', 'Jensen1515', '1998/25/02', 'Female', 'Roskilde', userInterestArray[1]);
...
let user5 = new PaymentUser('Mette', 'Thomsen', 'mette23001@live.dk', 'mette4545', '1998/26/2', 'Female', 'København', userInterestArray[2], "9540-3400-2340-2352", "Jagtvej 28");
let user6 = new PaymentUser('emma', 'rye', 'emmarye25@live.dk', 'emmarye545', '1996/23/2', 'Female', 'København', userInterestArray[1],  "2350-2430-2320-5452", "Tårnblæser vej 3");
